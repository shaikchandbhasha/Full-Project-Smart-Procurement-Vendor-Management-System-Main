      ...
      <Container maxWidth="lg">
        ...
        <Paper elevation={0} sx={{ p: 2, mb: 3, border: "1px solid #e0e0e0", borderRadius: "12px" }}>
          <Stack direction="row" spacing={2} alignItems="center">
            <TextField fullWidth placeholder="Search PO Number or Vendor..." size="small" value={search} onChange={(e) => setSearch(e.target.value)} InputProps={{ startAdornment: <InputAdornment position="start"><SearchIcon fontSize="small"/></InputAdornment> }} />
            ...
            <TableBody>
              {poList.map((p) => (
                <TableRow key={p.id} hover>
                  ...
                  <TableCell sx={{ color: '#1a237e', fontWeight: 'bold' }}>₹ {parseFloat(p.totalAmount || 0).toLocaleString()}</TableCell>
